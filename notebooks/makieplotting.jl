...
# ╔═╡ a011f722-8851-11ec-14a7-db91ad86b32c
using CairoMakie

# ╔═╡ 1cd2044f-2fdc-4376-b044-7ceaa861722e
scatterlines(1:10, rand(10))

# ╔═╡ d44303a6-f70d-418c-87b6-b8ee1a2ce0d9
begin
	f = Figure()
pos = f[1, 1]
...
# ╔═╡ de67ebb4-5f24-43ba-9ec8-62b46ab4ff84
lines(f[1,2], cumsum(randn(100)))


# ╔═╡ e740bc81-7e6a-4de9-882f-305a3867f4b0
f

# ╔═╡ 8a42e838-400b-4c16-b83f-626745792b43
heatmap(f[1, 3], randn(10, 10))

# ╔═╡ fe75d5f3-0e4e-4f7e-9f0d-ca6c8a8f957c
f

# ╔═╡ 78af8037-6080-42cd-9537-497d5b0321a7
let
	f = Figure()

f[1, 1] = Axis(f, title = "I'm not nested")
# f[1, 2][1, 1] = Axis(f,title = "I'm nested")
scatter(f[1, 2][1, 1], rand(10))
...
# ╔═╡ 3b23400c-b868-4aef-84ba-52a854818261
let
    μs = [0.25, 2, -1]
    σs = [1.25, 1, 2]
